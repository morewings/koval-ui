...
//  *  );
//  */
// export const libraryAPITestCase = <TProps,>(Component: FC<TProps>, name: string, defaultProps = {} as TProps) => {
...
//             const {getByTestId} = render(
//                 <Component {...defaultProps} dataAttributes={{testid: propValue}} {...{[propName]: propValue}} />
//             );
...
//             const {getByTestId} = render(
//                 <Component {...defaultProps} dataAttributes={{testid: propValue}} className={propValue} />
//             );
